...
public class PrepBattaglia : MonoBehaviour
{
    ...
    public void RealTimeSliders(Player player, Soldiers.Swordsmen swordsmen, Soldiers.Archers archers, Soldiers.Riders riders, Caserma caserma, Captain1 Capitano)
    {
        ...
        bonusTotal.text = "" + capBonus + terriBonus + troopsBonus + "%";

        totalSelected.text = "Total selected: " + (int)swordsmenSlider.value + (int)archersSlider.value + (int)ridersSlider.value;
        totalAtk.text = "ATK: " + swordsmen.getAtk() * (int)swordsmenSlider.value + archers.getAtk() * (int)archersSlider.value + riders.getAtk() * (int)ridersSlider.value;
        totalDef.text = "DEF: " + swordsmen.getDef() * (int)swordsmenSlider.value + archers.getDef() * (int)archersSlider.value + riders.getDef() * (int)ridersSlider.value;
